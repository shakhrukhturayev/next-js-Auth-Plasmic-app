...
import sty from "./PlasmicButton.module.css"; // plasmic-import: mFOYVC1VnDhM/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: NFW10nZnNEWO/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: deZo0rOp0K8E/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg___3Lu9Y)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__eg5D3)}
                role={"img"}
              />
            ),
