...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: el7VZOZcqcjc/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: 5npmulpJ-uW1/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: NFW10nZnNEWO/icon
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__sCi9P)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__zDXv)}
              role={"img"}
            />
          ),
